...
updateGreeting = function(){
    hour = TODAY.getHours();
    if (hour>=5 & hour<=11){
        greetingElement.innerHTML = "Good Morning, <br>WELCOME TO TO DO-LIST";
    }else if (hour>=12 & hour<=16){
        greetingElement.innerHTML = "Good Afternoon, <br>WELCOME TO TO DO-LIST";
    }else{
        greetingElement.innerHTML = "Good Evening, <br>WELCOME TO TO DO-LIST";
    }
}
